...
const RebootConfirm = ({ close, shown, onAccept }) => {
  ...
  const reset = () => {
    router.push(
      `/reset?default_users=${default_users}&settings=${settings}&notifications=${notifications}&detections=${detections}&del_user_photos=${del_user_photos}&del_detect_files=${del_detect_files}&del_exports=${del_exports}&del_errors=${del_errors}&del_system_logs=${del_system_logs}&passed=${true}`
    );
  };
    ...
    >
      <div className="modal-box">
        ...
        <p className="text-sm mt-2">
          These are states that will be affected on reset, you can choose what
          to include on reset.
        </p>
        <div className="mt-4">
          ...
          <p className=" text-sm font-normal">
            Primary storage of configurations, accounts, detections, etc..
          </p>
          ...
          <div className="form-control font-medium">
            ...
            <p className="text-xs font-normal">
              Remove all users except root user
            </p>
            <label className="label mt-2  cursor-pointer  flex justify-start">
              <input
                type="checkbox"
            ...
            <p className="text-xs font-normal">
              Remove all detection records on database (raw files not included)
            </p>
          ...
          <p className=" text-sm font-normal">
            PHS also save data's on storage aside from database. These can also
            be deleted
          </p>
          ...
          <div className="form-control mt-2 font-medium">
            ...
            <p className=" text-xs font-normal">
              User profile pictures at{" "}
              <span className="font-bold">public/images/*</span>
            </p>
            ...
            <p className=" text-xs font-normal">
              Raw detection data's at{" "}
              <span className="font-bold">public/detection/*</span>
            </p>
            ...
            <p className=" text-xs font-normal">
              Copy of Exported data files at{" "}
              <span className="font-bold">public/exports/*</span>
            </p>
